 ...
 * @author KOTRESHA
 */
public class encryptDES extends javax.swing.JFrame {
String key="Java@123#";
    /**
     * Creates new form encryptDES
     */
    public encryptDES() {
        initComponents();
...
setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        jButton2.setText("OPEN ENCRYPTED FILE ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            Thread.sleep(500);
            desen.encrypt(key,fis,fos);
            jLabel5.setText(n);
        }catch(Exception e)
        {
            System.out.println("Exception in encryptDES");
        }}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(encryptDES.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new encryptDES().setVisible(true);
            }
        });
    }
